...
// Node *stack::createNode(int vertex)
// {
//     Node *newNode = (Node *)malloc(sizeof(Node));
//     newNode->vertex = vertex;
//     newNode->next = NULL;
...
// Graph *stack::createGraph(int vertices)
// {
//     Graph *graph = (Graph *)malloc(sizeof(Graph));
//     graph->numVertices = vertices;
...
// void stack::freeGraph(Graph *graph)
// {
//     for (int i = 0; i < graph->numVertices; i++)
//     {
//         Node *temp = graph->adjLists[i], *next = NULL;
...
//     free(graph);
// }
// void stack::addEdge(Graph *graph, int src, int dest)
// {
//     // printf("adding edge %d, %d\n", src, dest);
//     Node *newNode = stack::createNode(dest - 1);
//     newNode->next = graph->adjLists[src - 1];
//     graph->adjLists[src - 1] = newNode;
// }

// void stack::dfs(Graph *graph, int vertex, int *stack, int *stackIndex)
// {
//     graph->visited[vertex] = true;
...
// Graph *stack::getTranspose(Graph *graph)
// {
//     Graph *transpose = createGraph(graph->numVertices);
...
// void stack::dfsPrint(Graph *graph, int vertex)
// {
//     graph->visited[vertex] = true;
//     // printf("%d ", vertex + 1);
//     std::cout<<" "<<vertex +1;
...
// void stack:: kosaraju(Graph *graph)
// {
//     int vertices = graph->numVertices;
//     int stack[vertices];
//     int stackIndex = 0;
